...
export const containers: Container[] = [
  ...
  { id: 'c-eu9x', type: 'XEPZ', name: '恒泰建材', region: '华东', credit: 82, domainTag: 'E_MARKET' },
  { id: 'c-eu10x', type: 'XEPZ', name: '沃野农产', region: '华中', credit: 84, domainTag: 'E_MARKET' },
...
export const units: Unit[] = [
  ...
  { id: 'u-eu9x', code: 'EU-HT', name: '恒泰建材', role: 'EU', side: 'B', containerId: 'c-eu9x', domainTags: ['E_MARKET'], tier: 'L2', credit: 82 },
  { id: 'u-eu10x', code: 'EU-WY', name: '沃野农产', role: 'EU', side: 'B', containerId: 'c-eu10x', domainTags: ['E_MARKET'], tier: 'L2', credit: 84 },
  ...
  { id: 'u-eu9h', code: 'EU-RF', name: '瑞丰耗材', role: 'EU', side: 'B', containerId: 'c-eu08', domainTags: ['E_MARKET'], tier: 'L2', credit: 85 },
  { id: 'u-eu10h', code: 'EU-HX', name: '华信紧固', role: 'EU', side: 'B', containerId: 'c-eu09', domainTags: ['E_MARKET'], tier: 'L2', credit: 88 },
  ...
  { id: 'u-cu-ep1', code: 'CU-EP1', name: '恒晟企业客户', role: 'CU', side: 'C', containerId: 'c-eu01', domainTags: ['E_MARKET'], tier: 'L2', credit: 88 },
  ...
  { id: 'u-dcx2', code: 'DCX-ZW', name: '知味·风物门店执行', role: 'DCX', side: 'C', containerId: 'c-du', domainTags: ['DE_MARKET'], tier: 'L2', credit: 94, dispatch: true },
...
export const booths: Booth[] = [
  ...
  { id: 'b-dc1', code: 'Booth-DC-01', domain: 'DE', kind: 'du', name: '合和·直营门店(Mall)', ownerUnitId: 'u-du1', execUnitId: 'u-dcx', operatorContainerId: 'c-du', chain: 'face', mode: 'DU·DCX → Booth-DC（Mall C端门店）', frontDesc: '直营门店：面向 CU 自然人零售（Mall C端）', backDesc: 'Booth 实体·SVC 门店作业系统（DCX 履约）', franchise: 'direct', status: 'open', rating: 4.9, listingCount: 14 },
  { id: 'b-dc2', code: 'Booth-DC-02', domain: 'DE', kind: 'du', name: '知味·风物直营店(Mall)', ownerUnitId: 'u-du1', execUnitId: 'u-dcx2', operatorContainerId: 'c-du', chain: 'face', mode: 'DU·DCX → Booth-DC（Mall C端门店）', frontDesc: '知味风物直营：地方特产/食品生鲜/粮油日百零售（Mall C端）', backDesc: 'Booth 实体·SVC/WH 门店作业系统（DCX 履约）', franchise: 'direct', status: 'open', rating: 4.8, listingCount: 20 },
];
...
export const listings: Listing[] = [
  ...
  { id: 'l15', boothId: 'b-dc1', domain: 'DE', title: '门店·生活服务套餐(个人)', unit: '次', priceCents: 19900, tags: ['B2C', 'Mall'], category: 'daily', stock: 50, img: '/img/mall/sku-33.svg', desc: '门店到家生活服务套餐（个人）：保洁/维修/照护任选一次，预约上门。' },
  { id: 'l16', boothId: 'b-dc1', domain: 'DE', title: '门店·零售商品(个人)', unit: '件', priceCents: 8900, tags: ['B2C', 'Mall'], category: 'daily', stock: 100, img: '/img/mall/sku-34.svg', desc: '门店精选零售商品（个人）：日用百货随机好物一件，门店自提或同城配送。' },
  /* ===== XMK-MALL-RICH-01 集市内容扩容（32 SKU · 四品类 · 本地 SVG 图，供集映射 b-e1） ===== */
  { id: 'l101', boothId: 'b-dc1', domain: 'DE', title: '智谷鲜蔬·每日净菜组合', unit: '份', priceCents: 2990, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 120, img: '/img/mall/sku-1.svg', supplyBoothId: 'b-e1', desc: '当日采摘净菜配送到家，八种时蔬自由组合，免洗免切开袋即烹。' },
  { id: 'l102', boothId: 'b-dc1', domain: 'DE', title: '合和牧场·鲜鸡蛋 30 枚', unit: '盒', priceCents: 2580, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 200, img: '/img/mall/sku-2.svg', supplyBoothId: 'b-e1', desc: '谷物散养鲜鸡蛋，当日产当日发，蛋壳坚固蛋黄饱满。' },
  { id: 'l103', boothId: 'b-dc1', domain: 'DE', title: '当日鲜牛奶·家庭订奶周卡', unit: '周', priceCents: 6800, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 80, img: '/img/mall/sku-3.svg', supplyBoothId: 'b-e1', desc: '75℃巴氏鲜奶每日鲜送，七天周卡随订随送。' },
  { id: 'l104', boothId: 'b-dc1', domain: 'DE', title: '冷链三文鱼刺身拼', unit: '份', priceCents: 12800, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 30, img: '/img/mall/sku-4.svg', supplyBoothId: 'b-e1', desc: '全程 -2℃ 冷链直达，冰鲜刺身级三文鱼腹背拼盘。' },
  { id: 'l105', boothId: 'b-dc1', domain: 'DE', title: '有机草莓·产地直采', unit: '盒', priceCents: 3980, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 60, img: '/img/mall/sku-5.svg', supplyBoothId: 'b-e1', desc: '高山有机草莓，熟果直采不加催熟剂，甜度 12+。' },
  { id: 'l106', boothId: 'b-dc1', domain: 'DE', title: '五常稻花香·真空装 5kg', unit: '袋', priceCents: 8980, tags: ['B2C', 'Mall', '粮油调味'], category: 'grain', stock: 150, img: '/img/mall/sku-6.svg', supplyBoothId: 'b-e1', desc: '核心产区五常大米，当年新米真空锁鲜。' },
  { id: 'l107', boothId: 'b-dc1', domain: 'DE', title: '古法压榨花生油 2L', unit: '桶', priceCents: 9900, tags: ['B2C', 'Mall', '粮油调味'], category: 'grain', stock: 90, img: '/img/mall/sku-7.svg', supplyBoothId: 'b-e1', desc: '物理压榨无添加，浓郁花生香，炒菜凉拌皆宜。' },
  { id: 'l108', boothId: 'b-dc1', domain: 'DE', title: '云南小粒咖啡豆·中度烘 250g', unit: '袋', priceCents: 5800, tags: ['B2C', 'Mall', '粮油调味'], category: 'grain', stock: 70, img: '/img/mall/sku-8.svg', supplyBoothId: 'b-e1', desc: '普洱高海拔小粒种，柑橘调明亮酸质。' },
  { id: 'l109', boothId: 'b-dc1', domain: 'DE', title: '知味·金华火腿礼盒', unit: '盒', priceCents: 11800, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 40, img: '/img/mall/sku-9.svg', supplyBoothId: 'b-e1', desc: '传统冬腿工艺，三年陈香，切片即食炖汤两宜。' },
  { id: 'l110', boothId: 'b-dc1', domain: 'DE', title: '手工红糖块·古法熬制', unit: '袋', priceCents: 4580, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 110, img: '/img/mall/sku-10.svg', supplyBoothId: 'b-e1', desc: '十八口连环锅古法熬糖，甘蔗清香回甘不齁。' },
  { id: 'l111', boothId: 'b-dc1', domain: 'DE', title: '竹纤维洗碗巾·10 片装', unit: '包', priceCents: 1990, tags: ['B2C', 'Mall', '日用百货'], category: 'daily', stock: 300, img: '/img/mall/sku-11.svg', supplyBoothId: 'b-e1', desc: '天然竹纤维速干不掉絮，油污一擦即净。' },
  { id: 'l112', boothId: 'b-dc1', domain: 'DE', title: '大理石纹陶瓷餐具·四件套', unit: '套', priceCents: 15900, tags: ['B2C', 'Mall', '日用百货'], category: 'daily', stock: 45, img: '/img/mall/sku-12.svg', supplyBoothId: 'b-e1', desc: '釉下彩工艺安全性高，微波洗碗机均可。' },
  { id: 'l113', boothId: 'b-dc2', domain: 'DE', title: '知味·鲜笋尖腌笃鲜食材包', unit: '份', priceCents: 4980, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 65, img: '/img/mall/sku-13.svg', supplyBoothId: 'b-e1', desc: '春笋尖+咸肉+鲜五花肉配齐，一包还原江南腌笃鲜。' },
  { id: 'l114', boothId: 'b-dc2', domain: 'DE', title: '深海鳕鱼排·免切装', unit: '袋', priceCents: 8800, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 85, img: '/img/mall/sku-14.svg', supplyBoothId: 'b-e1', desc: '阿拉斯加深海鳕鱼，去刺免切，宝宝辅食安心之选。' },
  { id: 'l115', boothId: 'b-dc2', domain: 'DE', title: '现磨豆浆原料·东北黄豆 1kg', unit: '袋', priceCents: 1980, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 260, img: '/img/mall/sku-15.svg', supplyBoothId: 'b-e1', desc: '东北非转基因黄豆，豆香浓郁出浆率高。' },
  { id: 'l116', boothId: 'b-dc2', domain: 'DE', title: '高山小番茄·串收', unit: '斤', priceCents: 3880, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 95, img: '/img/mall/sku-16.svg', supplyBoothId: 'b-e1', desc: '高原昼夜温差孕育，皮薄爆汁酸甜比黄金。' },
  { id: 'l117', boothId: 'b-dc2', domain: 'DE', title: '散养土鸡·冷链整只', unit: '只', priceCents: 15800, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 35, img: '/img/mall/sku-17.svg', supplyBoothId: 'b-e1', desc: '林间散养 280 天，肉质紧实炖汤金黄油亮。' },
  { id: 'l118', boothId: 'b-dc2', domain: 'DE', title: '头水紫菜·无沙免洗', unit: '袋', priceCents: 3580, tags: ['B2C', 'Mall', '食品生鲜'], category: 'food', stock: 130, img: '/img/mall/sku-18.svg', supplyBoothId: 'b-e1', desc: '头水嫩芽紫菜，汤色清亮口感细滑。' },
  { id: 'l119', boothId: 'b-dc2', domain: 'DE', title: '太行小米·黄澄澄新米 2kg', unit: '袋', priceCents: 4980, tags: ['B2C', 'Mall', '粮油调味'], category: 'grain', stock: 140, img: '/img/mall/sku-19.svg', supplyBoothId: 'b-e1', desc: '太行山旱地小米，米油厚粥面挂帘。' },
  { id: 'l120', boothId: 'b-dc2', domain: 'DE', title: '镇江香醋·十年陈 580ml', unit: '瓶', priceCents: 6980, tags: ['B2C', 'Mall', '粮油调味'], category: 'grain', stock: 100, img: '/img/mall/sku-20.svg', supplyBoothId: 'b-e1', desc: '固态发酵十年陈酿，酸而不涩香而微甜。' },
  { id: 'l121', boothId: 'b-dc2', domain: 'DE', title: '头道初榨橄榄油 750ml', unit: '瓶', priceCents: 12900, tags: ['B2C', 'Mall', '粮油调味'], category: 'grain', stock: 55, img: '/img/mall/sku-21.svg', supplyBoothId: 'b-e1', desc: '单-origin 庄园头道冷榨，果香浓郁酸度 0.4% 以下。' },
  { id: 'l122', boothId: 'b-dc2', domain: 'DE', title: '血糯米·江南水乡 1kg', unit: '袋', priceCents: 2980, tags: ['B2C', 'Mall', '粮油调味'], category: 'grain', stock: 160, img: '/img/mall/sku-22.svg', supplyBoothId: 'b-e1', desc: '江南水乡血糯米，煮粥酿酒皆宜，花青素满满。' },
  { id: 'l123', boothId: 'b-dc2', domain: 'DE', title: '知味·明前龙井·特级 100g', unit: '罐', priceCents: 16800, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 50, img: '/img/mall/sku-23.svg', supplyBoothId: 'b-e1', desc: '西湖产区明前头采，豆花香清冽回甘。' },
  { id: 'l124', boothId: 'b-dc2', domain: 'DE', title: '武夷岩茶·大红袍礼盒', unit: '盒', priceCents: 22800, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 25, img: '/img/mall/sku-24.svg', supplyBoothId: 'b-e1', desc: '正岩山场三坑两涧，岩骨花香七泡有余韵。' },
  { id: 'l125', boothId: 'b-dc2', domain: 'DE', title: '云南普洱·七年陈饼 357g', unit: '饼', priceCents: 13800, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 60, img: '/img/mall/sku-25.svg', supplyBoothId: 'b-e1', desc: '勐海古树春料，干仓七年转化，枣香糯滑。' },
  { id: 'l126', boothId: 'b-dc2', domain: 'DE', title: '苏州采芝斋·松子糖', unit: '盒', priceCents: 2980, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 120, img: '/img/mall/sku-26.svg', supplyBoothId: 'b-e1', desc: '百年苏式糖果老铺，松仁酥脆甜而不腻。' },
  { id: 'l127', boothId: 'b-dc2', domain: 'DE', title: '柳州螺蛳粉·正版袋装', unit: '袋', priceCents: 1580, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 400, img: '/img/mall/sku-27.svg', supplyBoothId: 'b-e1', desc: '柳州原产地理标志，酸笋正宗汤底浓郁。' },
  { id: 'l128', boothId: 'b-dc2', domain: 'DE', title: '郫县豆瓣·红油特级 500g', unit: '瓶', priceCents: 2380, tags: ['B2C', 'Mall', '地方特产'], category: 'specialty', stock: 180, img: '/img/mall/sku-28.svg', supplyBoothId: 'b-e1', desc: '川菜之魂三年陈酿，红油亮泽酱香醇厚。' },
  { id: 'l129', boothId: 'b-dc2', domain: 'DE', title: '知味·帆布购物袋·加厚', unit: '只', priceCents: 3990, tags: ['B2C', 'Mall', '日用百货'], category: 'daily', stock: 220, img: '/img/mall/sku-29.svg', supplyBoothId: 'b-e1', desc: '12 安加厚帆布，知味原创插画印花，可装 15kg。' },
  { id: 'l130', boothId: 'b-dc2', domain: 'DE', title: '蜂窝加厚厨房纸·6 卷', unit: '提', priceCents: 2990, tags: ['B2C', 'Mall', '日用百货'], category: 'daily', stock: 240, img: '/img/mall/sku-30.svg', supplyBoothId: 'b-e1', desc: '四层蜂窝锁水结构，吸油吸水湿水不破。' },
  { id: 'l131', boothId: 'b-dc2', domain: 'DE', title: '竹制保鲜盒·三件套', unit: '套', priceCents: 7980, tags: ['B2C', 'Mall', '日用百货'], category: 'daily', stock: 75, img: '/img/mall/sku-31.svg', supplyBoothId: 'b-e1', desc: '天然竹盖硅胶密封，微波冷冻两用颜值党首选。' },
  { id: 'l132', boothId: 'b-dc2', domain: 'DE', title: '玻璃油壶·防漏刻度', unit: '只', priceCents: 4590, tags: ['B2C', 'Mall', '日用百货'], category: 'daily', stock: 130, img: '/img/mall/sku-32.svg', supplyBoothId: 'b-e1', desc: '高硼硅玻璃自动开合壶嘴，倒油不挂壁。' },
];
...
export const marketPowerMap: MarketPowerMapRow[] = [
  ...
  { action_code: 'supply_order_initiate', action_name: '供给单发起（询价下单）', power_bit: 'manage', allow_hats: ['DU', 'CU'], forbid_hats: ['EU', 'HU', 'YU', 'TU', 'EX', 'EXX', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'VDM', 'VEM', 'VHM', 'VYM', 'VTM', 'VDM', 'XU', 'NONE'], tier: 'edge', scope: 'booth', governance: 'XMK-API-01 矩阵：DU（含 XDPZ#DU）+ XEPZ#CU 企业入驻主体（CU 消费侧容器由端点前置校验 403）（X-SUPPLY-02）', escalate_rule: '', enabled: true },
  ...
  // XMK-API-01：supply_order_confirm 采购主体确认——DU 之外放行 CU（仅企业入驻主体 XEPZ 容器，端点前置准入已卡 XHPZ#CU 403）
  { action_code: 'supply_order_confirm', action_name: '供给单报价确认', power_bit: 'manage', allow_hats: ['DU', 'CU'], forbid_hats: ['EU', 'HU', 'YU', 'TU', 'EX', 'EXX', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'VDM', 'VEM', 'VHM', 'VYM', 'VTM', 'VDM', 'XU', 'NONE'], tier: 'edge', scope: 'booth', governance: 'DU/XEPZ#CU 确认报价成单（X-SUPPLY-02 基础闭环终态；XMK-API-01 矩阵 v3）', escalate_rule: '', enabled: true },
];
