...
export const units: Unit[] = [
  ...
  { id: 'u-vxm1', code: 'VXM-PLAT', name: '管家审批统筹（总运执行 VMX）', role: 'VXM', side: 'B', containerId: 'c-plat', domainTags: ['E_MARKET', 'H_MARKET', 'Y_MARKET', 'T_MARKET', 'DE_MARKET'], tier: 'L3', credit: 99 },
];
...
export const marketPowerMap: MarketPowerMapRow[] = [
  ...
  // X-MARKET-ROLE-01 治理分线：四源治理动作 allow = VXM 统筹 + VEM/VHM/VYM/VTM 家族（按本源域）；
  // VDM 归 market 经营治理（经营管理），不再参与四源准入/货品/采购审批（allow 移除 VDM）
  { action_code: 'supplier_evaluate', action_name: '供应商评估（通过/驳回）', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'cross_tenant', governance: '审批留痕（四源分线：家族帽仅本源域，端点域校验；V*U 平台方监管系 VEU/VYU/VHU/VTU/VCU+VDU 全域壳 · X-MARKET-18 域内审批记 V*M 管家帽，总级归 O*M）', escalate_rule: '', enabled: true },
  ...
  { action_code: 'product_govern_remove', action_name: '治理下架（平台运营）', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'cross_tenant', governance: '治理动作（四源分线：家族帽仅本源域，端点域校验；V*U 平台方监管系 VEU/VYU/VHU/VTU/VCU+VDU 全域壳 · X-MARKET-18）', escalate_rule: '', enabled: true },
  ...
  { action_code: 'order_approval', action_name: '大额采购治理审批（通过/驳回）', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'cross_tenant', governance: '大额采购升级审批（X-MARKET-15；X-MARKET-ROLE-01 归 supply 面 V*M 家族；V*U 平台方监管系+VDU 壳 · X-MARKET-18 域内审批记 V*M 管家帽）', escalate_rule: '仅可审批 pending_approval 采购单；DU 不可自批', enabled: true },
  { action_code: 'threshold_update', action_name: '采购单笔阈值配置', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'platform', governance: '规则治理（X-MARKET-15；配置入口归四源管家审批台；V*U 平台方监管系+VDU 壳 · X-MARKET-18）', escalate_rule: '', enabled: true },
  ...
  { action_code: 'supply_order_initiate', action_name: '供给单发起（询价下单）', power_bit: 'manage', allow_hats: ['DU'], forbid_hats: ['EU', 'HU', 'YU', 'TU', 'EX', 'EXX', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'VXM', 'VEM', 'VHM', 'VYM', 'VTM', 'VDM', 'XU', 'CU', 'NONE'], tier: 'edge', scope: 'booth', governance: 'X-Supply 采购主体=DU 唯一经营号（X-SUPPLY-02）', escalate_rule: '', enabled: true },
  { action_code: 'supply_order_accept', action_name: '供给单接单', power_bit: 'manage', allow_hats: ['EU', 'HU', 'YU', 'TU'], forbid_hats: ['DU', 'EX', 'EXX', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'VXM', 'VEM', 'VHM', 'VYM', 'VTM', 'VDM', 'XU', 'CU', 'NONE'], tier: 'edge', scope: 'booth', governance: '供给方管位经营决策，仅本铺（X-SUPPLY-02）', escalate_rule: '', enabled: true },
  { action_code: 'supply_order_quote', action_name: '供给单报价', power_bit: 'manage', allow_hats: ['EU', 'HU', 'YU', 'TU'], forbid_hats: ['DU', 'EX', 'EXX', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'VXM', 'VEM', 'VHM', 'VYM', 'VTM', 'VDM', 'XU', 'CU', 'NONE'], tier: 'edge', scope: 'booth', governance: '接单后报价，仅本铺（X-SUPPLY-02）', escalate_rule: '', enabled: true },
  { action_code: 'supply_order_confirm', action_name: '供给单报价确认', power_bit: 'manage', allow_hats: ['DU'], forbid_hats: ['EU', 'HU', 'YU', 'TU', 'EX', 'EXX', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'VXM', 'VEM', 'VHM', 'VYM', 'VTM', 'VDM', 'XU', 'CU', 'NONE'], tier: 'edge', scope: 'booth', governance: 'DU 确认报价成单（X-SUPPLY-02 基础闭环终态）', escalate_rule: '', enabled: true },
];
