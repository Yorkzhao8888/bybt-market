...
export const marketPowerMap: MarketPowerMapRow[] = [
  ...
  { action_code: 'supplier_evaluate', action_name: '供应商评估（通过/驳回）', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'cross_tenant', governance: '审批留痕（四源分线：家族帽仅本源域，端点域校验）', escalate_rule: '', enabled: true },
  ...
  { action_code: 'product_govern_remove', action_name: '治理下架（平台运营）', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'cross_tenant', governance: '治理动作（四源分线：家族帽仅本源域，端点域校验）', escalate_rule: '', enabled: true },
  ...
  { action_code: 'order_approval', action_name: '大额采购治理审批（通过/驳回）', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'cross_tenant', governance: '大额采购升级审批（X-MARKET-15；X-MARKET-ROLE-01 归 supply 面 V*M 家族）', escalate_rule: '仅可审批 pending_approval 采购单；DU 不可自批', enabled: true },
  { action_code: 'threshold_update', action_name: '采购单笔阈值配置', power_bit: 'govern', allow_hats: ['VXM', 'VEM', 'VHM', 'VYM', 'VTM'], forbid_hats: ['YU', 'EU', 'HU', 'TU', 'DU', 'DYX', 'DHX', 'DTX', 'DEX', 'DCX', 'NONE'], tier: 'cloud', scope: 'platform', governance: '规则治理（X-MARKET-15；配置入口归四源治理台）', escalate_rule: '', enabled: true },
