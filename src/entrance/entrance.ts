...
export const ROLE_BRIEF: Record<string, RoleBrief> = {
  ...
  DEX: { face: 'Market · 经营面', duty: '执行作业：履约执行回执 / 铺内作业（办位）' },
  DCX: { face: 'Market · 经营面', duty: '执行作业：履约执行回执 / 铺内作业（办位）' },
  ...
  VXM: { face: 'Supply · 四源治理面', duty: '统筹全域：准入审核 / 货品治理 / 大额审批 / 阈值配置' },
  VEM: { face: 'Supply · 四源治理面', duty: 'E 源治理：通货源准入审核与货品治理' },
  VHM: { face: 'Supply · 四源治理面', duty: 'H 源治理：人力源准入审核与货品治理' },
  VYM: { face: 'Supply · 四源治理面', duty: 'Y 源治理：云资源源准入审核与货品治理' },
  VTM: { face: 'Supply · 四源治理面', duty: 'T 源治理：技术源准入审核与货品治理' },
};
